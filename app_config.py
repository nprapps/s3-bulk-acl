...
PROJECT_SLUG = 's3-bulk-acl'

# Project name to be used in file paths
PROJECT_FILENAME = 's3_bulk_acl'

# The name of the repository containing the source
REPOSITORY_NAME = 's3-bulk-acl'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_KEY = '1OD44eQfkubnkNryvHEfpvh_uQcnw1W8GyPg2PUg-i_U'
